...
class UIConfigState:
    ...
    batch_ero_doujinshi_mode: bool = False
    ...
    def to_save_dict(self) -> dict[str, Any]:
        ...
        data = {
            ...
            "batch_ero_doujinshi_mode": self.batch_ero_doujinshi_mode,
    ...
    def from_dict(data: dict[str, Any]) -> "UIConfigState":
        ...
        return UIConfigState(
            ...
            llm_settings=UITranslationLLMSettings(
                ...
                ero_doujinshi_mode=bool(
                    data.get(
                        "ero_doujinshi_mode",
                        defaults.get("ero_doujinshi_mode", False),
                    )
                ),
                ocr_correction=bool(
                    data.get("ocr_correction", defaults.get("ocr_correction", False))
                ),
                force_cache_translations=bool(
                    data.get(
            ...
            batch_ero_doujinshi_mode=bool(
                data.get(
                    "batch_ero_doujinshi_mode",
                    defaults.get("batch_ero_doujinshi_mode", False),
                )
            ),
...
def map_ui_to_backend_config(
    ...
    translation_cfg = TranslationConfig(
        ...
        ero_doujinshi_mode=(
            ui_state.batch_ero_doujinshi_mode
            if is_batch
            else ui_state.llm_settings.ero_doujinshi_mode
        ),
