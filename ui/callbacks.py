...
def _build_ui_state_from_args(args: tuple, is_batch: bool) -> UIConfigState:
    ...
    (
        ...
        outside_text_osb_outline_ratio_val,
        ...
        ero_doujinshi_mode_val,
        batch_ero_doujinshi_mode_val,
    ...
    final_ero_doujinshi_mode = (
        batch_ero_doujinshi_mode_val if is_batch else ero_doujinshi_mode_val
    )
    ...
    return UIConfigState(
        ...
        outside_text=UIOutsideTextSettings(
            ...
            osb_outline_ratio=float(outside_text_osb_outline_ratio_val),
        ...
        batch_ero_doujinshi_mode=bool(batch_ero_doujinshi_mode_val),
...
def handle_reset_defaults_click(fonts_base_dir: Path) -> list[gr.update]:
    ...
    return [
        ...
        default_ui_state.llm_settings.ero_doujinshi_mode,
        default_ui_state.batch_ero_doujinshi_mode,
        ...
        default_ui_state.outside_text.osb_outline_ratio,
